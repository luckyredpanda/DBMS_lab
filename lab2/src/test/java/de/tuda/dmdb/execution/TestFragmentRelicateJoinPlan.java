...
import de.tuda.dmdb.execution.exercise.FragmentReplicateJoinPlan;
...
public class TestFragmentRelicateJoinPlan extends TestCase {
   ...
   */
  @Test
  public void testFragementReplicateJoin() throws InterruptedException {
    ...
    ordersRecord2.setValue(0, new SQLInteger(0));
    orders2.insert(ordersRecord2);

    expectedResult.add(customerRecord2.append(ordersRecord1));
    expectedResult2.add(customerRecord1.append(ordersRecord2));

    int nodeId = 0;
    int listenerPort = 6200;
    ...
    Runnable task1 =
        () -> {
          ...
          FragmentReplicateJoinPlan localJoin1 =
              new FragmentReplicateJoinPlan(
                  tableScanCustomers,
                  tableScanOrders,
                  leftJoinAtt,
                  rightJoinAtt,
