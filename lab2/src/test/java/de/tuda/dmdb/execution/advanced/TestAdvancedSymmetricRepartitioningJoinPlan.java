...
public class TestAdvancedSymmetricRepartitioningJoinPlan extends TestCase {
  ...
  protected void testSymmetricRepartitioningJoinPlan(
  ...
  /**
   * Execute a SymmetricRepartitioningJoin with 2 nodes and to bigger input relations
   *
   * @throws InterruptedException
   */
  @Test
  public void testSymmetricRepartitioningJoinPlanWithMoreData() throws InterruptedException {}

  /**
   * Execute a SymmetricRepartitioningJoin with multiple nodes
   *
   * @throws InterruptedException
   */
  @Test
  public void testSymmetricRepartitioningJoinPlanWithMultiplePeers() throws InterruptedException {}
}
