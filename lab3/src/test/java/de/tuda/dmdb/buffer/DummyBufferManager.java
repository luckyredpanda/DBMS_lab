...
public class DummyBufferManager extends BufferManagerBase {
  ...
  public AbstractPage pin(Integer pageId) {
    /* TODO accidentally left pageTable out here. We need to check memory consumption or similar in
     *   tests, to make sure students use pin() and also their BufferManager stores not all pages in
     *   memory */
